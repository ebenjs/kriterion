...
<template>
  ...
  <KriterionValidator :activate-errors="false" @error="captureError">
    ...
    <template v-slot:errors>
      ...
      <div class="block">
        ...
        <KriterionInput v-model="inputValue" renderType="textarea" placeholder="Alphabetic Values" validationType="alpha"
          :hasSpace="true" :minLength="1" :maxLength="5" :isRequired="false" class="custom-input-style">
        </KriterionInput>
      </div>
      ...
      <div class="block">
        ...
        <KriterionInput placeholder="Number" validationType="number" :min="1" :max="10" numberType="int"
          :isRequired="true" class="custom-input-style" />
      </div>
      ...
      <div class="block">
        ...
        <KriterionPassword :repeated="true" class="custom-input-style" errorClass="error" :hasNumerical="true"
          :hasLowerCase="true" :hasUpperCase="true" :hasSpecialChar="false" :minLength="10"
          :placeholder="{ first: 'First Placeholder', second: 'Second Placeholder' }" v-model="passwordValue">
